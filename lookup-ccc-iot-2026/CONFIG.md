...
To avoid hitting account restrictions, the concurrecy limit for this lambda will be 2.

1. Go to the **Configuration** tab, then select **Concurrency** on the left menu.
2. Click **Edit** under Reserved concurrency.
3. Set the **Reserved concurrency** to **2**.
4. Click **Save**.

## Step 6: Verify IAM Permissions (`LabRole`)
...
## Step 7: Verify the API Gateway Trigger
