...
A Crawler's job is to act like a scout. It will automatically read those nested `year=2026/month=02/day=23/` folders in your Gold bucket, figure out the schema, and build a table for Athena to query.
